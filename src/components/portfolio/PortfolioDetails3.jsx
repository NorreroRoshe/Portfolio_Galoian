              ...
              <div className="col-xxl-4 col-xl-4 col-lg-5 col-md-5">
                <div className="portfolio__detail-info">
                  <ul>
                    ...
                    <li>
                      Start Date <span>1 January 2023</span>
                    </li>
                    <li>
                      Handover <span> 1 August 2023</span>
                    </li>
                    <li>
                    Link to the project : <Link style={{color: '#0000cb', textDecoration: 'underline !important'}} href='https://butterflylc.store'>butterflylc.store</Link>
                    </li>
                    <li>
          ...
          <div className="container g-0 line pt-140">
            ...
            <div className="block-img-text">
              ...
              <Link target='_blank' href='https://butterflylc.store' style={{marginRight: 'auto'}}>
                Link to the project : butterflylc.store
              </ Link>
              <br/>
              {/* Link to code:  */}
              </p>
