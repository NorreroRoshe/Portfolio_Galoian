...
const PersonalPortfolioHeaderDetails = () => {
        ...
        <div className="header__logo-5">
          ...
          <div className="header__nav-icon-5">
            <div id="open_offcanvas" style={{fontSize: '18px'}}>
              <span className="menu-text-pp" style={{fontSize: 'inherit'}}><Link href='portfolio-details-ru2'>RU</Link></span>
...
export default PersonalPortfolioHeaderDetails;
