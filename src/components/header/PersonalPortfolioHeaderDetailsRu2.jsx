...
const PersonalPortfolioHeaderDetailsRu2 = () => {
        ...
        <div className="header__logo-5">
          ...
          <div className="header__nav-icon-5">
            <div id="open_offcanvas" style={{fontSize: '18px'}}>
              <span className="menu-text-pp" style={{fontSize: 'inherit'}}>RU</span>
              <span className="menu-text-pp" style={{fontSize: 'inherit'}}><Link href='portfolio-details2'>EN</Link></span>
            </div>
          </div>
        </div>
      </header>
...
export default PersonalPortfolioHeaderDetailsRu2;
