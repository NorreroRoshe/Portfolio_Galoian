...
const resumeLink = "/assets/imgs/service/GaloyanSVRU.pdf";

const ServiceDetailsDevelopmentRu = () => {
        ...
        <div className="container g-0 line pt-130 pb-150">
          ...
          <div className="row">
            ...
            <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
              ...
              <div className="development__img" style={{height: '100px'}}>
                <h2><Link href={resumeLink}>Скачать резюме</Link></h2>
              </div>
            </div>
            ...
            <div className="development__img" style={{ margin: '0 auto', marginTop: '40px', textAlign: 'center', textDecoration: 'underline', color: 'blue'}}>
              <h2><Link href={resumeLink}>View the full CV</Link></h2>
            </div>  
          </div>
        </div>
      </section>
...
export default ServiceDetailsDevelopmentRu;
